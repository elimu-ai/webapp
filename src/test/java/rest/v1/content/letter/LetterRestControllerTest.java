package rest.v1.content.letter;
...
public class LetterRestControllerTest {
    ...
    public void testList_missingParameters() {
    	String jsonResponse = JsonLoader.loadJson(DomainHelper.getRestUrlV1() + "/content/letter/list");
    ...
    public void testList_success() {
        ...
        assertThat(jsonObject.has("letters"), is(true));
    }
}
