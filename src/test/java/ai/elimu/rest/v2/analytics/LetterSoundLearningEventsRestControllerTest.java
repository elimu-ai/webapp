...
public class LetterSoundLearningEventsRestControllerTest {

    @InjectMocks
    private LetterSoundLearningEventsRestController letterSoundLearningEventsRestController;
    ...
    public void testHandleUploadCsvRequest_invalidFilename() {
        ...
        String jsonResponse = letterSoundLearningEventsRestController.handleUploadCsvRequest(multipartFile, response);
    ...
    public void testHandleUploadCsvRequest_emptyFile() {
        MultipartFile multipartFile = new MockMultipartFile(
                "file",
                "7161a85a0e4751cd_3002023_letter-sound-learning-events_2025-05-28.csv",
                "text/csv",
                "".getBytes()
        );
        String jsonResponse = letterSoundLearningEventsRestController.handleUploadCsvRequest(multipartFile, response);
