...
public class NumberAssessmentEventsRestControllerTest {

    @InjectMocks
    private NumberAssessmentEventsRestController numberAssessmentEventsRestController;
    ...
    public void testHandleUploadCsvRequest_invalidFilename() {
        ...
        String jsonResponse = numberAssessmentEventsRestController.handleUploadCsvRequest(multipartFile, response);
    ...
    public void testHandleUploadCsvRequest_emptyFile() {
        MultipartFile multipartFile = new MockMultipartFile(
                "file",
                "7161a85a0e4751cd_4000022_number-assessment-events_2025-07-01.csv",
                "text/csv",
                "".getBytes()
        );
        String jsonResponse = numberAssessmentEventsRestController.handleUploadCsvRequest(multipartFile, response);
