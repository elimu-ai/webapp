...
public class NumberLearningEventsRestControllerTest {

    @InjectMocks
    private NumberLearningEventsRestController numberLearningEventsRestController;
    ...
    public void testHandleUploadCsvRequest_invalidFilename() {
        ...
        String jsonResponse = numberLearningEventsRestController.handleUploadCsvRequest(multipartFile, response);
    ...
    public void testHandleUploadCsvRequest_emptyFile() {
        MultipartFile multipartFile = new MockMultipartFile(
                "file",
                "7161a85a0e4751cd_3004004_number-learning-events_2025-06-12.csv",
                "text/csv",
                "".getBytes()
        );
        String jsonResponse = numberLearningEventsRestController.handleUploadCsvRequest(multipartFile, response);
