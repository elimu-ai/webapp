...
public class CsvAnalyticsExtractionHelperTest {
    ...
    /**
     * Test extraction of data from CSV files generated by version 3002024 of the Analytics app: 
     * https://github.com/elimu-ai/analytics/releases/tag/3.2.24
     */
    @Test
    public void testExtractWordAssessmentEvents_v3002024() throws IOException {
        ResourceLoader resourceLoader = new ClassRelativeResourceLoader(CsvAnalyticsExtractionHelper.class);
        Resource resource = resourceLoader.getResource("5b7c682a12ecbe2e_3002024_word-assessment-events_2025-06-01.csv");
        File csvFile = resource.getFile();
        
        List<WordAssessmentEvent> wordAssessmentEvents = CsvAnalyticsExtractionHelper.extractWordAssessmentEvents(csvFile);
        assertEquals(2, wordAssessmentEvents.size());
