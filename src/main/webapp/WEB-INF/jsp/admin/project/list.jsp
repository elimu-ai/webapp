...
<content:section cssId="adminProjectListPage">
    ...
    <div class="fixed-action-btn" style="bottom: 2em; right: 2em;">
        <a href="<spring:url value='/admin/project/create' />" class="btn-floating btn-large tooltipped" data-position="left" data-delay="50" data-tooltip="<fmt:message key="add.project" />"><i class="material-icons">playlist_add</i></a>
    </div>
</content:section>
