    ...
    <div class="card-panel">    
        <div class="row">
            <div class="col s12">
                ...
                <p>
                    <a class="publishLink" href="<spring:url value="/application-version/create?applicationId=${application.id}" />"><i class="material-icons left">new_releases</i>Publish new APK file</a>
                </p>
