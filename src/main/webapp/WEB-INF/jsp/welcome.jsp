...
<content:banner>
    ...
    <div class="row center">
        <a href="#contributeInfoContainer" id="join-button-top" class="btn-large waves-effect waves-light deep-purple lighten-2">Contribute now</a>
        <script>
            $(function() {
...
<content:section cssId="welcomePage">
        ...
        <div class="row">
          ...
          <div class="col s12 m4">
            <div class="icon-block">
              ...
              <h4 class="center">Why?</h4>

              <p class="light center">The word "elimu" is Swahili for "education."&nbsp;We believe that a quality basic education is the right of <i>every child</i>, no matter her social or geographical background.</p>
            </div>
          </div>
    ...
    <div class="section">
        ...
        <div class="row center">
            <h4 class="header">Contribute now</h4>
