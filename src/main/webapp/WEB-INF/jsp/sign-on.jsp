...
<content:section cssId="signOnPage">
    <h2 class="center"><i class="material-icons large">group</i></h2>
    ...
    <div class="section">
        <div class="row section">
            ...
            <div class="col s12 m4 offset-m2">
                <a href="http://eepurl.com/bGihkr" class="col s12 btn-large waves-effect waves-light red darken-2">
                    ...
                    &nbsp;<fmt:message key="sign.on.via" /> Google+
                </a>
            </div>
            ...
            <div class="col s12 m4">
                <a href="http://eepurl.com/bGihkr" class="col s12 btn-large waves-effect waves-light blue darken-3">
                    ...
                    &nbsp;<fmt:message key="sign.on.via" /> Facebook
                </a>
            </div>
        </div>
        ...
        <div class="row section">
            ...
            <div class="col s12 m4 offset-m4">
                <a href="http://eepurl.com/bGihkr" class="col s12 btn-large waves-effect waves-light grey darken-1">
                    ...
                    &nbsp;<fmt:message key="sign.on.via" /> GitHub
                </a>
            </div>
        </div>
    </div>    
