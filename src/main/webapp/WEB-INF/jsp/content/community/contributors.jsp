            ...
            <div class="card" style="overflow: hidden;">
                ...
                <div class="card-content">
                    ...
                    <%--<c:if test="${not empty contributor.slackId}">--%>
                        <p><a href="https://elimu-ai.herokuapp.com" target="_blank"><i class="material-icons left">chat_bubble_outline</i>Chat with <c:out value="${contributor.firstName}" /> in Slack</a></p>
                    <%--</c:if>--%>
                </div>
