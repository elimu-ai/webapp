            ...
            <div class="row nav-wrapper">
                <div class="col s1">
                    <ul id="nav-mobile" class="side-nav">
                        ...
                        <li><a href="<spring:url value='/content/sounds/list' />"><i class="material-icons left">music_note</i><fmt:message key="sounds" /></a></li>
                ...
                <div class="col s5">
                    ...
                    <c:if test="${!fn:contains(pageContext.request.requestURI, '/jsp/content/main.jsp')}">
                        <c:choose>
                            ...
                            <c:when test="${fn:contains(pageContext.request.requestURI, '/content/sounds/')
                                    && !fn:endsWith(pageContext.request.requestURI, '/list.jsp')}">
                                <a class="breadcrumb" href="<spring:url value='/content/sounds/list' />"><fmt:message key="sounds" /></a>
                            </c:when>
