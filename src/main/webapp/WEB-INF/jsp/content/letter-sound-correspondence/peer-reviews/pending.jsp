                ...
                <tbody>
                    <c:forEach var="letterSoundCorrespondenceContributionEvent" items="${letterSoundCorrespondenceContributionEventsPendingPeerReview}">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<spring:url value='/content/letter-sound-correspondence/edit/${letterSoundCorrespondenceContributionEvent.id}#peer-review' />" target="_blank"><fmt:message key="peer.review" /></a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
