                    ...
                    <td>
                        ...
                        <c:choose>
                            <c:when test="${empty wordMap[wordText]}">
                                ...
                                <a href="<spring:url value='/content/word/create?autoFillText=${fn:toLowerCase(wordText)}' />" target="_blank"><fmt:message key="add.word" /> <i class="material-icons">launch</i></a>
                            </c:when>
                            <c:otherwise>
