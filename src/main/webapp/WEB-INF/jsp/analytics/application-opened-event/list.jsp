...
<content:section cssId="applicationOpenedEventListPage">
    <div class="section row">
        <c:if test="${empty applicationOpenedEvents}">
            ...
            <p>Remember to install the <a href="https://github.com/literacyapp-org/literacyapp-analytics" target="_blank">LiteracyApp Analytics</a> application on the tablet(s).</p>
        </c:if>
