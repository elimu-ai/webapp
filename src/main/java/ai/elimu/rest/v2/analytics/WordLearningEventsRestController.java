...
/**
 * REST API endpoint for receiving word learning events from the 
 * <a href="https://github.com/elimu-ai/analytics">Analytics</a> application.
 */
@RestController
@RequestMapping(value = "/rest/v2/analytics/word-learning-events/csv", produces = MediaType.APPLICATION_JSON_VALUE)
@Slf4j
public class WordLearningEventsRestController {
    ...
    public String handleUploadCsvRequest(
        ...
        try {
            ...
            if (originalFilename.length() != "7161a85a0e4751cd_3001012_word-learning-events_2020-04-23.csv".length()) {
