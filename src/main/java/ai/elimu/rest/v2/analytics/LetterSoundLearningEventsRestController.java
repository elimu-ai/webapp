 ...
 */
@RestController
@RequestMapping(value = "/rest/v2/analytics/letter-sound-learning-events/csv", produces = MediaType.APPLICATION_JSON_VALUE)
@Slf4j
public class LetterSoundLearningEventsRestController {
    ...
    public String handleUploadCsvRequest(
        ...
        try {
            ...
            // Expected format: "7161a85a0e4751cd_3001012_letter-sound-learning-events_2020-04-23.csv"
            String originalFilename = multipartFile.getOriginalFilename();
            log.info("originalFilename: " + originalFilename);
            if (originalFilename.length() != "7161a85a0e4751cd_3001012_letter-sound-learning-events_2020-04-23.csv".length()) {
