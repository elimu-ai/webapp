    ...
    drop table if exists PeerReviewEvent CASCADE ;
    ...
    alter table PeerReviewEvent 
       add constraint FK5y8cteknddkkvfaskr9bn8nd3 
       foreign key (contributor_id) 
       references Contributor;

    alter table PeerReviewEvent 
       add constraint FKilxrlojslxukqgkxmuv6ae4ok 
       foreign key (audioContributionEvent_id) 
       references AudioContributionEvent;

    alter table PeerReviewEvent 
       add constraint FK5a5j7nm3dhcluj81qtsboipcu 
       foreign key (storyBookContributionEvent_id) 
       references StoryBookContributionEvent;

    alter table PeerReviewEvent 
       add constraint FKjw1lykk5wtt3abp8rda870dag 
