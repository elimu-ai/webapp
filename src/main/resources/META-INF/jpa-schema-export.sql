    ...
    create table LetterToAllophoneMapping_Allophone (
       LetterToAllophoneMapping_id bigint not null,
        allophones_id bigint not null,
        allophones_ORDER integer not null,
    ...
    create table Word_Letter (
       Word_id bigint not null,
        letters_id bigint not null,
        letters_ORDER integer not null,
        primary key (Word_id, letters_ORDER)
    );
    ...
    alter table LetterToAllophoneMapping 
       add constraint FKqrjrkvvl2oqd6fpejwm26s55r 
       foreign key (letter_id) 
       references Letter;

    alter table LetterToAllophoneMapping_Allophone 
       add constraint FKth4oyrcav0a19p5cv0bglh4ru 
       foreign key (allophones_id) 
       references Allophone;

    alter table LetterToAllophoneMapping_Allophone 
       add constraint FKfte4vq0mwx2i812mvtnft48a 
       foreign key (LetterToAllophoneMapping_id) 
       references LetterToAllophoneMapping;

    alter table LetterToAllophoneMapping_Letter 
       add constraint FK7yyfk46si4eks4jx6a7wh4hxo 
       foreign key (letters_id) 
       references Letter;

    alter table LetterToAllophoneMapping_Letter 
       add constraint FK9ndst2hywiv2cx4eyhtnxs6nk 
       foreign key (LetterToAllophoneMapping_id) 
       references LetterToAllophoneMapping;
    ...
    alter table Word_Letter 
       add constraint FKjh49wqg5lyf3xg3awkfv4bnn9 
       foreign key (letters_id) 
       references Letter;

    alter table Word_Letter 
       add constraint FKgsivb1vwi2t2ejwsdasdwwjou 
       foreign key (Word_id) 
       references Word;
    ...
    alter table Word_LetterToAllophoneMapping 
       add constraint FKqtcn7heh8ye54wa5lcwesfsmf 
       foreign key (Word_id) 
       references Word;
