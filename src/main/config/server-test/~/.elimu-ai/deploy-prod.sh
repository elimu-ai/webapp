...
ssh root@$PROD_SERVER export GOOGLE_APPLICATION_CREDENTIALS="/path/to/google-cloud-service-account-key.json"
ssh root@$PROD_SERVER echo "GOOGLE_APPLICATION_CREDENTIALS: \"${GOOGLE_APPLICATION_CREDENTIALS}\""
